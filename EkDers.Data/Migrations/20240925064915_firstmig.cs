        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProgramKodu = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AktifProgramMi = table.Column<bool>(type: "bit", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c30e774-4b13-4ec4-b354-157728ffb11c"), new DateTime(2024, 9, 25, 9, 49, 14, 891, DateTimeKind.Local).AddTicks(9480), "Müdür", false },
                    { new Guid("35084397-55c0-47bb-b1fe-17f02ff27601"), new DateTime(2024, 9, 25, 9, 49, 14, 891, DateTimeKind.Local).AddTicks(9501), "Öğretmen", false },
                    { new Guid("3b4dcbef-c723-40be-b73e-19cd09604c59"), new DateTime(2024, 9, 25, 9, 49, 14, 891, DateTimeKind.Local).AddTicks(9500), "Müdür Yardımcısı", false }
                });
