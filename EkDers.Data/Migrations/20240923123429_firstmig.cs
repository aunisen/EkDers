        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DerseHazrilikEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    NobetGunIndex = table.Column<int>(type: "int", nullable: false),
                    NobetEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    NobetTutuyormu = table.Column<bool>(type: "bit", nullable: false),
                    SinifOgremenligiKlupDersSaati = table.Column<int>(type: "int", nullable: false),
                    SinifOgremenligiKlupGoreviVarmi = table.Column<bool>(type: "bit", nullable: false),
                    PazartesiYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    SaliYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    CarsambaYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    PersembeYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    CumaYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    CumartesiYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    PazarYazilacakEkdersSaati = table.Column<int>(type: "int", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0c30e774-4b13-4ec4-b354-157728ffb11c"), new DateTime(2024, 9, 23, 15, 34, 29, 112, DateTimeKind.Local).AddTicks(8558), "Müdür", false },
                    { new Guid("35084397-55c0-47bb-b1fe-17f02ff27601"), new DateTime(2024, 9, 23, 15, 34, 29, 112, DateTimeKind.Local).AddTicks(8577), "Öğretmen", false },
                    { new Guid("3b4dcbef-c723-40be-b73e-19cd09604c59"), new DateTime(2024, 9, 23, 15, 34, 29, 112, DateTimeKind.Local).AddTicks(8575), "Müdür Yardımcısı", false }
                });
